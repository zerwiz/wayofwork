...
export function SimplePage() {
  ...
  const viewSimpleMenu: ViewMenuSimpleOptions = {
    ...
    onSeedViewsCatalog: async () => {}, 
    onEditCatalog: () => {}, 
    onOpenSchemaDoc: () => {}, 
    catalogRelPath: ".wayofwork/ui-views.json",
    catalogSource: "default",
    catalogLoading: false,
    catalog: [],
    onActivateEntry: () => {},
    catalogError: null,
    catalogParseWarning: null
  };
  ...
  return (
    ...
    >
      <SimpleApp
        ...
        onConsumeProviderConfigFocus={() => setSimpleProviderPath(null)}
        ...
        planHandoffWorkspaceKey={undefined} 
        onMoveFileToDirectory={handleExplorerMoveFile}
        allowWorkspaceRootDrop={tree.folders.length === 1}
        simpleMobileMenuFileFocusRev={simpleMobileMenuFileFocusRev}
      />
    </IdeLayout>
    <ModalsRenderer

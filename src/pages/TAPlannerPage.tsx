...
import { TAPlanDetailModal } from "../components/taplanner/TAPlanDetailModal";
...
export function TAPlannerPage() {
  ...
  const [selectedPlan, setSelectedPlan] = useState<TAPlan | null>(null);
  ...
  return (
    <div className="flex h-full bg-[#1e1e1e] text-[#cccccc]">
      {selectedPlan && (
        <TAPlanDetailModal plan={selectedPlan} onClose={() => setSelectedPlan(null)} />
      )}
      {/* Plans panel */}
                  ...
                  <div key={plan.id} className="group flex flex-col bg-[#252526] border border-[#3c3c3c] rounded-2xl overflow-hidden hover:border-[#ea580c]/50 transition-all shadow-sm">
                    ...
                    <div className="p-4 bg-[#1e1e1e]/50 flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 text-xs font-bold text-[#ea580c] hover:text-[#fb923c] transition-colors"
                      >
                        Open Plan
        ...
        <div className="relative flex w-[420px] shrink-0 flex-col border-l border-[#3c3c3c] bg-[#252526]">
          <div className="sticky top-0 z-10 flex items-center justify-between px-4 py-3 border-b border-[#3c3c3c]">
            ...
            <button
              ...
              className="p-1 rounded text-[#858585] hover:text-white hover:bg-[#3c3c3c] transition-colors"
            >
              <X size={16} />
            </button>
          </div>

    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-4">
          ...
          {pushMode === 'existing' && selectedBoardId && selectedColumnId && (
            <div>
              ...
              {availableCards.length === 0 ? (
                <div className="px-4 py-3 bg-[#252526]/60 border border-orange-500/30 rounded-lg text-center text-[#858585]">
          ...
          {pushMode === 'new' && (
            <div>
              <label className="block text-sm font-semibold text-white mb-2">Card Title</label>
              <input
                type="text"
                value={cardTitle}
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 bg-[#252526]/60 backdrop-blur-sm border border-orange-500/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500/50 text-white input-text transition-all hover:border-orange-500/50 resize-none"

...
const DEFAULT_ENTRIES: UiViewCatalogEntry[] = [
	...
	{ id: "ext-agent-team", label: "Extension: agent-team", kind: "openFile", target: "extensions/agent-team" },
	{ id: "ext-agent-chain", label: "Extension: agent-chain", kind: "openFile", target: "extensions/agent-chain" },
	{ id: "ext-pi-pi", label: "Extension: pi-pi", kind: "openFile", target: "extensions/pi-pi" },
	{ id: "ext-extension-picker", label: "Extension: extension-picker", kind: "openFile", target: "extensions/extension-picker" },
	{ id: "ext-system-select", label: "Extension: system-select", kind: "openFile", target: "extensions/system-select" },
	{ id: "ext-session-memory", label: "Extension: session-memory", kind: "openFile", target: "extensions/session-memory" },
